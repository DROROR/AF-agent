@echo off
REM Thin launcher for DYO-Worker-NestedExecution-Update.ps1 - see
REM NESTEDEXECUTION-UPDATE-README.txt.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0DYO-Worker-NestedExecution-Update.ps1"
