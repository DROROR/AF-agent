@echo off
REM Thin launcher for DYO-Worker-PreviewRegen-Update.ps1 - see README-FIRST.txt.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0DYO-Worker-PreviewRegen-Update.ps1"
