DYO WINDOWS WORKER - PHASE 5 UPDATE (READ-ONLY INSPECTION)
==============================================================
...
2. Double-click DYO-Worker-Phase5-Update.bat
...
WHAT THIS UPDATES
-------------------
- Adds real, read-only template inspection to DYO Worker - the ability to
  ask ae-mcp basic, read-only questions about an open After Effects
  project (composition names, project info) once DYO explicitly requests
  it in a later step. This update does not run any inspection itself -
  it only installs the capability.
