@echo off
REM Thin launcher for DYO-Worker-CheckHealth-Update.ps1 - see README-FIRST.txt.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0DYO-Worker-CheckHealth-Update.ps1"
