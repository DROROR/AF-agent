@echo off
REM Thin launcher for DYO-Worker-Inspector-Update.ps1 - see README-FIRST.txt.
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0DYO-Worker-Inspector-Update.ps1"
