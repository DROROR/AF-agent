DYO WINDOWS WORKER - COMPOSITION TIMELINE DIAGNOSTICS UPDATE
==============================================================
...
2. Double-click DYO-Worker-CompositionTimeline-Update.bat
...
WHAT THIS UPDATES
-------------------
Adds a new, read-only diagnostic that lets the dashboard ask exactly what
a composition's own real duration, work area, and layer timing look like
- used to investigate why a Complete Preview's visible content ends
earlier than the master timeline's own full length. This update does not
run any diagnostic itself - it only installs the capability; the
dashboard's own "Describe LANDSCAPE/REELS timeline" buttons are what
actually trigger it, on demand.
